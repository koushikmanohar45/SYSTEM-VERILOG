module priority_if_else();
  ...
  function void nothing();
     begin
       ...
       $display(" A=%0d \n B=%0d \n C=%0d",a,b,c);
    priority if(~a[7] && ~b[7] && ~c[7])begin
       priority if(a>b && a>c)begin
...
testbench.sv, 9
  ...
  for the last 'else if' block, inside priority_if_else.nothing, at time 0ns.
...
testbench.sv, 9
  No condition matches in 'priority if' statement. 'else' statement is missing
  for the last 'else if' block, inside priority_if_else.nothing, at time 1ns.
