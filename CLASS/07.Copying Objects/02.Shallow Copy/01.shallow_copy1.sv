 // In shallow copy,memory of the nested object is shared
...
class mux ;
  ...
  task display();
    ...
    endcase
      ...
      $display("        |\\");
      $display("        | \\");
      $display("d0=%0d---|  |",s.in[0]);
      $display("        |  |");
      $display("d1=%0d---|  |",s.in[1]);
      $display("        |  |-----y=%0d",s.out);
      $display("d2=%0d---|  |",s.in[2]);
      $display("        |  |");
      $display("d3=%0d---|  |",s.in[3]);
      $display("        | /");
      $display("        |/|");  
      $display("        .||");
      $display("         ||");
...
endclass
 ...
 module object_copy();
   ...
   initial begin
    ...
    c2.sel=2'b11;
     $display("=========================================================");
     $display("AFTER MODIFYING COPIED  OBJECT (C2) in[1]=%0D sel=%b ",c2.s.in[1],c2.sel);
     $display("=========================================================");
