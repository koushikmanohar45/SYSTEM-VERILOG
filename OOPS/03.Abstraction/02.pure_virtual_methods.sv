virtual class protocol;
  ...
  pure virtual function void transfer_f();
  pure virtual task transfer_t();
...
class uart extends protocol;
  ...
  function void transfer_f();
    $display("uart function called");
    $display("====");
    $display("UART");
    $display("====");
    $display("data_frame=%b\n",data_frame);
  endfunction
  
  task transfer_t();
    $display("uart task called\n");
